  ...
  return (
    <div className="min-h-screen bg-white text-surface-900">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-surface-200">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold text-surface-900">AI Farmer</span>
          </Link>
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/signup"
              className="px-5 py-2 text-sm font-semibold bg-primary-600 hover:bg-primary-700 text-white rounded-xl transition-all shadow-md shadow-primary-600/20"
            >
              Get Started
            </Link>
          </div>
      ...
      <section className="relative pt-48 pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-primary-100/40 rounded-full blur-[140px]" />
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-50 border border-primary-200 mb-8">
              ...
              <span className="text-sm text-primary-700 font-medium">Powered by Google Gemini AI</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-black leading-tight mb-6">
              <span className="block text-surface-900">Your Smart</span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/signup"
                className="group px-8 py-4 bg-primary-600 hover:bg-primary-700 rounded-2xl text-lg font-semibold text-white transition-all shadow-xl shadow-primary-600/20 flex items-center gap-2"
              >
              ...
              <Link
                to="/login"
                className="px-8 py-4 bg-surface-100 hover:bg-surface-200 border border-surface-200 rounded-2xl text-lg font-medium text-surface-700 transition-all"
              >
                Log In
              </Link>
            </div>
            ...
            <div className="flex justify-center gap-6 flex-wrap">
              {[GiPlantSeed, GiWheat, GiSunCloud].map((Icon, i) => (
                <motion.div
                  ...
                  className="w-14 h-14 rounded-2xl bg-white border border-surface-200 shadow-sm flex items-center justify-center"
                >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="text-surface-900">Powerful </span>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className={`p-6 rounded-2xl bg-white border ${feature.border} hover:shadow-lg transition-all duration-300`}
              >
      ...
      <section className="py-20 px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-4xl mx-auto text-center p-12 rounded-3xl bg-gradient-to-br from-primary-50 to-green-50 border border-primary-200"
        >
          ...
          <Link
            to="/signup"
            className="inline-flex items-center gap-2 px-8 py-4 bg-primary-600 hover:bg-primary-700 rounded-2xl text-lg font-semibold text-white transition-all shadow-xl shadow-primary-600/20"
          >
            Sign Up Now
      ...
      <footer className="border-t border-surface-200 py-8 px-6 bg-surface-50">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-surface-500">AI Farmer Assistant © 2024</span>
          </div>
          <div className="flex items-center gap-6">
            <span className="text-xs text-surface-400">Made with ❤️ for Indian Farmers</span>
          </div>
        </div>
      </footer>
    </div>
